...
class LevelEndScreen extends FlxState
{
	...
	public function new(score:Int)
	{
		...
		txtGameScore.setPosition(FlxG.width / 2 - txtGameScore.width / 2 + 20, FlxG.height / 2 - txtGameScore.height - 45);
		...
		FlxTween.tween(windowHeader, {x: FlxG.width / 2 - windowHeader.width / 2 - 19}, 1.5, {ease: FlxEase.quadIn, onComplete: onHeaderAnimation});
	...
	private function onHeaderAnimation(tween:FlxTween):Void
	{
		FlxG.camera.shake();
