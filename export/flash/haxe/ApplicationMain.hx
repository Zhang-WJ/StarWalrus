...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StarWalrus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StarWalrus", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "StarWalrus";
		app.meta["name"] = "StarWalrus";
